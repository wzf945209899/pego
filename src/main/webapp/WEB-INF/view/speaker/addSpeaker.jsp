  ...
  <body>
    ...
    <div class="jumbotron" align="middle">
      <h2>编辑主讲人-主讲人管理</h2>
         ...
         <div class="body">
         	<div style="width: 60%;">
			  <form class="form-horizontal" method="post" action="${pageContext.request.contextPath }/admin/speaker/addSpeaker.action">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="inputPassword3" placeholder="主讲人职业" name="speakerJob">
			    </div>
			  </div>
			  <div class="form-group">
			    <label for="inputPassword3" class="col-sm-2 control-label">头像图片</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="inputPassword3" placeholder="主讲人头像图片" name="speakerHeadUrl">
			    </div>
			  </div>
			  <div class="form-group">
			    <label for="inputPassword3" class="col-sm-2 control-label">简介</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="inputPassword3" placeholder="主讲人简介" name="speakerDescr">
			    </div>
			  </div>
