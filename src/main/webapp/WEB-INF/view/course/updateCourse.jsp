		      ...
		      <div class="container-fluid" style="width: 60%;">
		        ...
		        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-9">
		          <ul class="nav navbar-nav">
		            <li ><a href="${pageContext.request.contextPath }/admin/recose/recoseList.action">视频管理</a></li>
		       ...
		       <div class="body">
		         	<div style="width: 60%;">
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-10">
					      <input type="text" class="form-control" id="inputPassword3" placeholder="课程标题" name="courseName" value="${li.courseName }">
					    </div>
					  </div>
					  <div class="form-group">
					    <label for="inputEmail3" class="col-sm-2 control-label">简介</label>
					    <div class="col-sm-10">
					      <input type="text" class="form-control" id="inputEmail3" placeholder="课程简介" name="courseDescr" value="${li.courseDescr }">
					    </div>
					  </div>
