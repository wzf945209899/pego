...
<div class="mask hidden" id="loginDiv">
	<div class="mask_content">
		...
		<div class="mask_content_body">
			<form id="loginForm" action="${pageConte.request.contextPath }/front/user/login.action" method="post">
				<h3>快速登录</h3>
				...
				<div id="forget">
					<a href="front/forgetpwd.action">忘记密码？</a>
				</div>
	...
	<div class="mask_content">
		...
		<div class="mask_content_body">
			<form id="regForm" action="/front/user/regist.action" method="post">
				<h3>新用户注册</h3>
				<input type="email" id="regEmail" placeholder="请输入邮箱" name="email"><span id="mm"></span>
	    ...
	    $("#regEmail").blur(function(){
			...
			$.ajax({
				...
				url:"${pageContext.request.contextPath}/front/user/email.action",
