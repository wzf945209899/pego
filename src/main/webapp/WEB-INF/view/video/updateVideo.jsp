       ...
       <div class="body">
         	<div style="width: 60%;">
			    ...
			    <div class="col-sm-10">
			      <select class="form-control" name="speakerId">
 				    <c:forEach items="${spList }" var="list">
					  <option value="${list.id }" ${speakerId eq list.id ? "selected":""}>${list.speakerName }</option>
					</c:forEach> 
				</select>
			    </div>
			  </div>
			    ...
			    <div class="col-sm-10">
			     <select class="form-control" name="courseId">
 					<c:forEach items="${coList }" var="list">
					  <option value="${list.id }" ${courseId eq list.id ? "selected":""}>${list.courseName }</option>
					</c:forEach>
				</select>
			    </div>
			  </div>
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="inputPassword3" placeholder="课程时长(秒)" name="videoPlayTimes" value="${video.videoPlayTimes }">
			    </div>
			  </div>
			  <div class="form-group">
			    ...
			    <!--  <input type="file" id="exampleInputFile" name="videoimageUrl" placeholder="封面图片"> -->
			     <input type="text" class="form-control" id="inputEmail3" placeholder="封面图片" name="videoImageUrl" value="${video.videoImageUrl }"> 
			    </div>
			  </div>
			   <div class="form-group">
			    <label for="inputEmail3" class="col-sm-2 control-label">视频播放地址</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="inputEmail3" placeholder="视频播放地址" name="videoUrl" value="${video.videoUrl }">
			    </div>
			  </div>
			   <div class="form-group">
			    <label for="inputEmail3" class="col-sm-2 control-label">视频简介</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="inputEmail3" placeholder="视频简介" name="videoDescr" value="${video.videoDescr }">
			    </div>
			   </div>
